...
import org.apache.hadoop.yarn.api.records.{ApplicationId, ApplicationReport, ContainerLaunchContext, FinalApplicationStatus, LocalResource, LocalResourceType, LocalResourceVisibility, Resource, YarnApplicationState}
