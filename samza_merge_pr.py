...
# ASF JIRA username
JIRA_USERNAME = os.environ.get("JIRA_USERNAME", "jagadish1989@gmail.com")
# ASF JIRA password
JIRA_PASSWORD = os.environ.get("JIRA_PASSWORD", "yogi.ram1")
...
DEFAULT_FIX_VERSION = os.environ.get("DEFAULT_FIX_VERSION", "0.10.0")
